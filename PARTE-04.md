...
- `Map<NivelDificultad, Integer> contarCursosPorNivelDificultad()`: Cuenta el número de cursos por cada nivel de dificultad. Por ejemplo, ```{“J.R.R.Tolkien”=2, “J.K.Rowling”=2, “S.King”=1}```
